...
[NOTE]
====
Dado que todas las licencias de VMware vSphere son compatibles, puedes elegir la licencia vSphere Remote Office Branch Office Standard o Advanced en lugar de la licencia Enterprise o Enterprise Plus.

Todas las licencias de vSphere y VSAN son compatibles.
