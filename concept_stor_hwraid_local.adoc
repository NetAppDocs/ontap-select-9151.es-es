...
NOTE: La sobrecarga de VMFS es distinta de cero (véase VMware KB 1001618), y el intento de utilizar todo el espacio indicado como libre por un datastore ha dado lugar a errores falsos durante las operaciones de creación de clúster.
