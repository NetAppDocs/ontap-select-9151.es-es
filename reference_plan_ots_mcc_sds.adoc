...
[role="lead"]
MetroCluster SDS es una opción de configuración cuando creas un clúster de dos nodos de ONTAP Select. Es similar a un despliegue de Remote Office/Branch Office (ROBO). Este despliegue mejorado de dos nodos ofrece escenarios de casos de uso adicionales. Debes conocer los requisitos y restricciones como parte de la preparación para desplegar MetroCluster SDS.
